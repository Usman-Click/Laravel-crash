<x-layouts.home>
    <div class="bg-gray-50 border border-gray-200 p-10 rounded max-w-lg mx-auto mt-24">
        ...
        <form method="POST" action="/listings/{{$listing->id}}" enctype="multipart/form-data">
            ...
            <div class="mb-6">
                <label for="mail" class="inline-block text-lg mb-2">Contact Email</label>
                <input type="text" class="border border-gray-200 rounded p-2 w-full" name="mail"
                    value="{{ $listing->mail }}" />
                @error('mail')
                    <div class="text-red-500 text-lg">{{ $message }}</div>
                @enderror
            ...
            <div class="mb-6">
                ...
                <img class="hidden w-24 mr-6 md:block"
